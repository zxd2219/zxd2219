...
export const collections = {
  ...
  articles_zh_cn: defineCollection(
    asSeoCollection({
      type: "page",
      source: {
        include: "zh_cn/articles/*.md",
        prefix: "/zh_cn/articles",
      },
  ...
  projects_zh_cn: defineCollection(
    asSeoCollection({
      type: "data",
      source: "zh_cn/projects/*.json",
  ...
  faq_zh_cn: defineCollection({
    type: "data",
    source: "zh_cn/faq.json",
